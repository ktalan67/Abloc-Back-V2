...
class __TwigTemplate_4790e6a7b4a207abba76b556469af5e49d4b04865b998bbdf549635922d065a6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table table-light text-center\">
        ...
        <tbody>
            <tr>
                <td>";
        // line 16
        echo twig_include($this->env, $context, "admin/user/_form.html.twig", ["button_label" => "Create"]);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
<div class=\"info-container\">
    ...
    <table class=\"table table-light text-center\">
        ...
        <tbody>
            <tr>
                <td>{{ include('admin/user/_form.html.twig', {'button_label': 'Create'}) }}</td>
            </tr>
        </tbody>
    </table>
        <div class=\"back-list-button\">
...
{% endblock %}
", "admin/user/new.html.twig", "/Users/richard/Documents/WEB/APOTHEOSE/ablock V2./templates/admin/user/new.html.twig");
    }
}
